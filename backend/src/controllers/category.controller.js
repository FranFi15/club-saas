...
import { parseCutoffDateInput } from '../utils/ageHelper.js';
...
const createCategory = asyncHandler(async (req, res) => {
    ...
    const category = await Category.create({
        ...
        edadMinima,
        edadMaxima,
        edadCorteDesde: parseCutoffDateInput(edadCorteDesde) || undefined,
        edadCorteHasta: parseCutoffDateInput(edadCorteHasta) || undefined,
...
const updateCategory = asyncHandler(async (req, res) => {
    ...
    if (edadCorteDesde !== undefined) {
        category.edadCorteDesde = parseCutoffDateInput(edadCorteDesde);
    }
    if (edadCorteHasta !== undefined) {
        category.edadCorteHasta = parseCutoffDateInput(edadCorteHasta);
    }
