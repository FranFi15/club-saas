...
const getMe = asyncHandler(async (req, res) => {
    ...
    } else if (user.rol === 'admin_club' || user.rol === 'administrativo') {
        pruebaPendiente = await User.find({
            rol: 'atleta',
            esPrueba: true,
            estado: { $ne: 'inactivo' },
            ...
            .select('_id nombre apellido esPrueba pruebaHasta pruebaDecision tutorPrincipal')
            .populate('tutorPrincipal', 'nombre apellido')
            .limit(50);
